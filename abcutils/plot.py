...
def locus_summary(dataframe, plot_metric, loci, ax=None):
    ...
    sma_short = abcutils.features.calculate_sma(dataframe, '_datetime_start', plot_metric, abcutils.features.SHORT_WINDOW)
    sma_long = abcutils.features.calculate_sma(dataframe, '_datetime_start', plot_metric, abcutils.features.LONG_WINDOW)

    ### plot the intercept points demarcating different regions
    sma_intercepts = abcutils.features.sma_intercepts(dataframe, plot_metric, abcutils.features.SHORT_WINDOW, abcutils.features.LONG_WINDOW)
    left_x = None
