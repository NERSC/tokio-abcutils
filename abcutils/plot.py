...
def sma_overlaps(dataframe, plot_metric, short_window, long_window, ax=None):
    ...
    sma_short = abcutils.features.calculate_sma(dataframe, '_datetime_start', plot_metric, short_window)
    sma_long = abcutils.features.calculate_sma(dataframe, '_datetime_start', plot_metric, long_window)

    ### plot the intercept points demarcating different regions
    sma_intercepts = abcutils.features.sma_intercepts(dataframe, plot_metric, short_window, long_window)
    left_x = None
...
def locus_summary(dataframe, plot_metric, loci, ax=None):
    ...
    sma_overlaps(dataframe, plot_metric, abcutils.features.SHORT_WINDOW, abcutils.features.LONG_WINDOW, ax=ax)
